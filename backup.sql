...
CREATE TABLE `burger` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `burger_name` (`burger_name`)
...
INSERT INTO `burger` VALUES (1,'Patty Melt',1),(2,'Baconator',1),(3,'Whooper',1),(4,'Frito Burger',0),(5,'Veggie Burger',0),(6,'Philly Cheesesteak Burger',0);
...
-- Dump completed on 2018-02-24 20:56:22
